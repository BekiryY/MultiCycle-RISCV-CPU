...
module controller(input  logic       clk, reset,
    ...
    // Main FSM chooses the multicycle step and emits high-level control signals.
...
module mainfsm(input  logic       clk, reset,
    ...
    always_comb begin
        case (state)
            ...
            // Opcode is decoded once the instruction register has been loaded.
            S_DECODE:   case (op)
    ...
    // Output logic
    always_comb begin
        // Defaults deassert writes and select the ALUOut path unless a state
        // explicitly needs a different source or register enable.
        ALUSrcA   = 2'b00;
        ALUSrcB   = 2'b00;
        ResultSrc = 2'b00;
        AdrSrc    = 1'b0;
...
module aludec(input  logic       opb5,
    ...
    always_comb
        case (ALUOp)
            ...
            // ALUOp=10 lets funct3/funct7 select R-type and I-type ALU ops.
...
module instrdec(input  logic [6:0] op,
    ...
    always_comb
        case (op)
            // ImmSrc encoding matches the cases implemented in extend().
